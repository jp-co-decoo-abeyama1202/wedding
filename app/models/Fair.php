...
class Fair extends Eloquent 
{
    ...
    public static $mList30 = array(
        null => '--',
        0  => '00',
        30 => '30',
    );
    
    public static $mList1 = array(
        null => '--',
        0 => '00',
        1 => '01',
        2 => '02',
    ...
    {
        $this->gnavi = isset($this->gnavi->id) ? $this->gnavi : new FairGnavi();
        $this->mwed = isset($this->mwed->id) ? $this->mwed : new FairMwed();
        $this->mynavi = isset($this->mynavi->id) ? $this->mynavi : new FairMynavi();
        $this->park =isset($this->park->id) ? $this->park : new FairPark();
        $this->rakuten = isset($this->rakuten->id) ? $this->rakuten : new FairRakuten();
        $this->sugukon = isset($this->sugukon->id) ? $this->sugukon : new FairSugukon();
        $this->zexy = isset($this->zexy->id) ? $this->zexy : new FairZexy();
    }
