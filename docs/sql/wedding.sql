...
CREATE TABLE IF NOT EXISTS `wedding`.`fairs` (
  ...
  `reserve_net_day` TINYINT(3) UNSIGNED,
  `reserve_net_time` TINYINT(3) UNSIGNED,
  `reserve_tel_day` TINYINT(3) UNSIGNED,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wedding`.`fair_gnavis` (
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `fair_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `wedding`.`fair_mwed_contents` (
    ...
    `dt_type` TINYINT(3) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `wedding`.`fair_zexys` (
    ...
    `tel_2_2` VARCHAR(4),
    `tel_3_2` VARCHAR(4),
    `tel_shubetsu_kbn_2` TINYINT(3) UNSIGNED,
